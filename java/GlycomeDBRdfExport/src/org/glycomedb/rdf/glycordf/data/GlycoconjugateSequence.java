...
public class GlycoconjugateSequence  extends Sequence 
{


    public GlycoconjugateSequence(){}
    
    public GlycoconjugateSequence(String a_uri)
    {
        this.setInstanceURI(a_uri);
    }

    public GlycoconjugateSequence(String a_uri, boolean a_isInstance)
    {
        this.setInstanceURI(a_uri);
