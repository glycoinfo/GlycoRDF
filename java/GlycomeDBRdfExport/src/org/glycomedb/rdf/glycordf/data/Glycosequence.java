...
public class Glycosequence  extends Sequence 
{


    public Glycosequence(){}
    
    public Glycosequence(String a_uri)
    {
        this.setInstanceURI(a_uri);
    }

    public Glycosequence(String a_uri, boolean a_isInstance)
    {
        this.setInstanceURI(a_uri);
